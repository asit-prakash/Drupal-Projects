...
$context["item"], "url", []), "getOption", [0 => "attributes"], "method"), "class", [])) ? (twig_join_filter($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["item"], "url", []), "getOption", [0 => "attributes"], "method"), "class", [])), " ")) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/navigation/menu--footer.html.twig", "/var/www/aus.gov.live.com/public_html/aus-gov/web/themes/contrib/bootstrap_barrio/templates/navigation/menu--footer.html.twig");
    }
}
